        ...
        if(ContextCompat.checkSelfPermission(getContext(), Manifest.permission.WRITE_EXTERNAL_STORAGE)
            ...
            if (intent.resolveActivity(getActivity().getPackageManager()) != null) {
                ...
                if (mTmpFile != null && mTmpFile.exists()) {
                    ...
                    /// CHANGED THE CODE BELOW TO WORK WITH SDKTARGETVERSION 25+
//                    Log.v("pakage",getActivity().getPackageName()+"");
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
//                        Uri  uri = FileProvider.getUriForFile(getActivity(),
//                               "me.nereo.multi_image_selector", mTmpFile);
//                        intent.putExtra(MediaStore.EXTRA_OUTPUT, uri);
//                        Log.v("sdk",">=24");
//                        try {
//                            intent.putExtra(MediaStore.EXTRA_OUTPUT, Uri.fromFile(FileUtils.createTmpFile(getActivity())));
//                        } catch (IOException e) {
//                            e.printStackTrace();
//                        }
                        intent.addFlags(Intent.FLAG_GRANT_READ_URI_PERMISSION);
                        Uri uri = FileProvider.getUriForFile(getActivity(), getActivity().getApplicationContext().getPackageName() + ".com.ideabonyan.iranapp.provider", mTmpFile);

//                        Uri contentUri = FileProvider.getUriForFile(getActivity(), "com.ideabonyan.iranapp.provider", mTmpFile);
                        intent.putExtra(MediaStore.EXTRA_OUTPUT, uri);
...
//                    Uri uri = FileProvider.getUriForFile(getActivity(),
////                            "com.example.sim.librariesprototype"
