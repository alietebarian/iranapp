...
public class Get_Volley_Call_Back2 {
    static Get_Insert_Edit_Data2 myGet_insert_edit_data;
    ...
    public static void binddata(Get_Insert_Edit_Data2 Get_insert_edit_data) {
