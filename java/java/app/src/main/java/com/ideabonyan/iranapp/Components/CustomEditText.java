...
public class CustomEditText extends MyEdittextView {
        ...
        if (event.getAction() == MotionEvent.ACTION_DOWN) {
            ...
            if (drawableRight != null) {
                ...
                x = getWidth() - x;
                 ...
                 /*x can be negative if users taps at x co-ordinate just near the width.
                 * e.g views width = 300 and users taps 290. Then as per previous calculation
