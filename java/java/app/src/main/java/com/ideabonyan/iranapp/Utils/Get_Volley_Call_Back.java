...
public class Get_Volley_Call_Back {
    static Get_Insert_Edit_Data myGet_insert_edit_data;
...
//                    Log.v("vollry_response",response);
    ...
    public static void binddata(Get_Insert_Edit_Data Get_insert_edit_data) {
