...
public class Get_Volley_Call_Back4 {
    static Get_Insert_Edit_Data4 myGet_insert_edit_data;
    ...
    public static void binddata(Get_Insert_Edit_Data4 Get_insert_edit_data) {
