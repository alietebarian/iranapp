...
<head>
    ...
    <title>ایران اپ - خطای سمت سرور</title>
...
<div class="wrapper-page">
    <div class="ex-page-content text-center">
        ...
        <h2>خطای سمت سرور</h2><br>
        <p class="text-muted">متاسفانه مشکلی در سرور پیش امده لطفا در تماس باشید با <a href="#">پشتیبانی</a></p>
        <br>
        <a class="btn btn-default waves-effect waves-light" href="{{ route('showAdminLoginForm') }}">بازگشت به خانه</a>
