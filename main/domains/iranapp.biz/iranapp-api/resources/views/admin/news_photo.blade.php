                ...
                <div class="card-box">
                    ...
                    <div class="row">
                        @foreach($photos as $photo)
                            <div class="col-xs-6 col-md-4" style="position:relative;">
                                <a href="{{ route('deleteNewsPhotoById' , $photo->id) }}"
                                   class="btn btn-danger btn-xs" style="position:absolute;top:25px;left:40px;">حذف</a>
                                <img src="{{ URL::to('/news_photo') }}/{{ $photo->file_name }}" alt="ads photo"
                    ...
                    @if($available_photo_to_upload > 0)
                        <div class="row">
                            ...
                            <div class="col-xs-12">
                                <form action="{{ route('uploadNewsPhotoInAdminPanel' , $news->id) }}" method="post"
