                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card-box">
                            ...
                            @endif
                            <h4 class="m-t-0 header-title"><b>افزودن برند</b></h4>
                            <form role="form" action="{{ route('saveVehicleAdsBrand') }}" method="post"
                                  enctype="multipart/form-data">
                                {{ csrf_field() }}
                                <div class="form-group">
                                    <label for="category_name_in_add_new">نام برند</label>
                                    <input name="name" value="{{ old('name') }}" type="text" class="form-control"
                                           id="category_name_in_add_new"
                                           placeholder="نام برند جدید را وارد کنید...">
                                </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card-box">
                            <div class="row">
                                <div class="col-lg-12">
                                    <h4 class="m-t-0 header-title"><b>برند ها</b></h4>
                                        ...
                                        <table class="table table-striped m-0">
                                            ...
                                            @foreach($brands as $item)
                                                <tr>
                                                    ...
                                                    <td>{{ $item->name }}</td>
                                                    <td>
                                                        <a href="{{ route('showAllVehicleAdsModelsInAdmin' , $item->id) }}">مشاهده مدل ها</a>
                                                    </td>
                                                    <td>
                                                        <a class="text-primary" href="" data-toggle="modal" data-target="#update-category-{{ $item->id }}-modal">ویرایش</a>
                                                        &nbsp;&nbsp;&nbsp;
                                                        <a class="text-danger"
                                                           href="{{ route('deleteBrandInAdminPanel' , $item->id) }}">حذف</a>
                                                    </td>
                                                </tr>
                                            @endforeach
                                            </tbody>
        ...
        <div id="update-category-{{ $item->id }}-modal" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true" style="display: none;">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form action="{{ route('updateVehicleAdsBrandInAdmin' , $item->id) }}" method="post" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="category-{{ $item->id }}-name-field" class="control-label">نام برند</label>
