                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card-box">
                            ...
                            @endif
                            <h4 class="m-t-0 header-title"><b>افزودن تخصص</b></h4>
                            <form role="form" action="{{ route('saveSpecialityInAdminPanel') }}" method="post"
                                  enctype="multipart/form-data">
                                {{ csrf_field() }}
                                <div class="form-group">
                                    <label for="category_name_in_add_new">نام تخصص</label>
                                    <input name="name" value="{{ old('name') }}" type="text" class="form-control"
                                           id="category_name_in_add_new"
                                           placeholder="نام تخصص جدید را وارد کنید...">
                                </div>
                                            ...
                                            @foreach($list as $item)
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        &nbsp;&nbsp;&nbsp;
                                                        <a class="text-danger"
                                                           href="{{ route('deleteSpecialityInAdminPanel' , $item->id) }}">حذف</a>
                                                    </td>
                                                </tr>
                                            @endforeach
                                            </tbody>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">ویرایش نام تخصص</h4>
                    </div>
                    <form action="{{ route('updateSpecialityInAdminPanel' , $item->id) }}" method="post" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="category-{{ $item->id }}-name-field" class="control-label">نام تخصص</label>
