...
class saveVipAd extends FormRequest
{
    /**
    ...
    public function messages()
    {
        return [
            ...
            'category_displaying.in' => 'فیلد نمایش در دسته ها می تواند تنها یکی از مقادیر نمایش در دسته بندی یا نمایش در زیر دسته بندی را داشته باشد.',
            ...
            'photo.required' => 'انتخاب تصویر الزامی است.',
