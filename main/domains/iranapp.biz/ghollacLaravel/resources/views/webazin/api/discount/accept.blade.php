    ...
    <div class="ex-page-content text-center">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <p class="text-success">امتیاز کنونی شما <span class="badge badge-dark">{{$user->walletSum}} امتیاز </span> می
                    باشد</p>
                <p>جهت مشاهده جوایز به اپلیکیشن و منوی جوایز مراجعه نمائید </p>
            </div>
            <hr>
        </div>
    </div>
