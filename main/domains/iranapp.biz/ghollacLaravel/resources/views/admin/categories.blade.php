                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card-box">
                            ...
                            @endif
                            <h4 class="m-t-0 header-title"><b>افزودن دسته جدید</b></h4>
                            <form role="form" action="{{ route('saveNewCategoryInAdminPanel') }}" method="post"
                                            ...
                                            <table class="table table-striped m-0">
                                                ...
                                                @foreach($list as $item)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="{{ route('showSubCategoriesInAdminPanel' , $item->id) }}">مشاهده
                                                                زیر دسته ها</a>
                                                        </td>
                                                        <td>
                                                            ...
                                                            &nbsp;&nbsp;&nbsp;
                                                            <a class="text-danger"
                                                               href="{{ route('deleteCategory' , $item->id) }}">حذف</a>
                                                        </td>
                                                    </tr>
                                                @endforeach
                                                </tbody>
        ...
        <div id="update-category-{{ $item->id }}-modal" class="modal fade" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form action="{{ route('UpdateCategoryInAdminPanel' , $item->id) }}" method="post"
                          enctype="multipart/form-data">
                        {{ csrf_field() }}
