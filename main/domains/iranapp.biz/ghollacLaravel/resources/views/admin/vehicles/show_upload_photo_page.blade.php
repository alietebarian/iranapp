        ...
        <div class="content">
            <div class="container">
                <div class="card-box">
                    ...
                    <a href="{{ route('showAllVehicleAdsInAdminPanel') }}"><b>بازگشت به لیست آگهی ها</b></a>
                    <div class="row">
                        @foreach($photos as $photo)
                            <div class="col-xs-6 col-md-4" style="position:relative;">
                                <a href="{{ route('deleteVehicleAdsPhoto' , $photo->id) }}"
                    ...
                    @if($available_photo_to_upload > 0)
                        <div class="row">
                            ...
                            <div class="col-xs-12">
                                <form action="{{ route('uploadVehicleAdsPhotoInAdminPanel' , $ad->id) }}" method="post"
