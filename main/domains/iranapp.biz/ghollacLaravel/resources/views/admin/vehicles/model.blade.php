                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card-box">
                            ...
                            @endif
                            <h4 class="m-t-0 header-title"><b> افزودن مدل جدید به برند <span
                                            class="text-danger">{{ $brand->name }}</span></b></h4>
                            <form role="form" action="{{ route('saveVehicleAdsModel' , $brand->id) }}"
                                  method="post">
                                {{ csrf_field() }}
                                <div class="form-group">
                                    <label for="category_name_in_add_new">نام مدل</label>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card-box">
                            <div class="row">
                                <div class="col-lg-12">
                                    <h4 class="m-t-0 header-title"><b>مدل های برند<span class="text-danger">{{ $brand->name }}</span></b></h4>
                                    ...
                                    <div class="p-20">
                                                ...
                                                @foreach($list as $item)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            &nbsp;&nbsp;&nbsp;
                                                            <a class="text-danger"
                                                               href="{{ route('deleteVehicleAdsInAdminPanel' , $item->id) }}">حذف</a>
                                                        </td>
                                                    </tr>
                                                @endforeach
                                                </tbody>
                                        ...
                                        @else
                                            <div class="text-pink text-center">هیچ مدلی یافت نشد!</div>
                                        @endif
                                    </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">ویرایش مدل</h4>
                    </div>
                    <form action="{{ route('updateModelNameInAdminPanel' , $item->id) }}" method="post"
